...
<body>
	...
	<div class="outer">
	<h2 align="center">호텔정책 작성</h2>
  	<form action="<%=request.getContextPath()%>/hotel.hp" method="post" encType="multipart/form-data">
  		
  		<div class=intertArea">
 <table align="center">
 	 <tr>
			<td width="100px">호텔정책</td>
			<td colspan="3"> 
			<textarea name="centent" rows="5" cols="120" ></textarea>
			</td>
		</tr></table>
		</div>
