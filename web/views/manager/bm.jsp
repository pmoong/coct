...
<body class="is-preload homepage">
	...
	<hr style="border-color:yellowgreen">
		<!-- 여기는 예약관리 입니당 -->
			...
			<div class="container" >
				<div class="row">
					<h3 class="col-4 col-12-medium" style='text-align: left ; margin-top:1%; border:red'><a href="../manager/notice.jsp">공지사항</a></h3>
					<h3 class="col-4 col-12-medium" style='text-align: left ; margin-top:1%;'><a href="../manager/reviewManager.jsp">리뷰관리</a></h3>
					<h3 class="col-4 col-12-medium" style='text-align: left ; margin-top:1%;'><a href="../manager/customerService.jsp">고객센터</a></h3>
