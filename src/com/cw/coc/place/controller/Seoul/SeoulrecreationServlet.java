 ...
 */
@WebServlet("/seoul.rec")
public class SeoulrecreationServlet extends HttpServlet {
	private static final long serialVersionUID = 1L;
       
    /**
     * @see HttpServlet#HttpServlet()
     */
    public SeoulrecreationServlet() {
        super();
...
ArrayList<SeoulVo> list = new SeoulService().selectrecList();
