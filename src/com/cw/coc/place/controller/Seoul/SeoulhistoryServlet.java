 ...
 */
@WebServlet("/seoul.his")
public class SeoulhistoryServlet extends HttpServlet {
	private static final long serialVersionUID = 1L;
       
    /**
     * @see HttpServlet#HttpServlet()
     */
    public SeoulhistoryServlet() {
        super();
...
ArrayList<SeoulVo> list = new SeoulService().selecthisList();
