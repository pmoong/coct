...
public class search {
	...
	public search() {
		...
		String fileName = 
				search.class.getResource("/sql/place/place-query.properties").getPath();
...
/*public class search 
{
    ...
    */
    ...
    // 글 삽입
   /* public boolean boardInsert(Place place)
    {
...
*/    
    ...
    // 글목록 가져오기
    public ArrayList<Place> getBoardList(HashMap<String, Object> listOpt)
    {
