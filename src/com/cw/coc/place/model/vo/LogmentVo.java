...
public class LogmentVo {
	...
	public LogmentVo(String ltitle,String ltel, int lcontenttypeid, String lcat1, String lcat2,
			String lcat3, String lmapx, String lmapy, String lfirstimage) {
		super();
		this.ltitle = ltitle;
 		this.ltel = ltel;
		this.lcontenttypeid = lcontenttypeid;
	...
	public String toString() {
		return "LogmentVo [ltitle=" + ltitle + ", ltel=" + ltel + ", lcontenttypeid="
				+ lcontenttypeid + ", lcat1=" + lcat1 + ", lcat2=" + lcat2 + ", lcat3=" + lcat3 + ", lmapx=" + lmapx
				+ ", lmapy=" + lmapy + ", lfirstimage=" + lfirstimage + "]";
	}
