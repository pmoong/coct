...
public class LogmentVo {
	...
	public String toString() {
		return "LogmentVo [ltitle=" + ltitle + ", laddr=" + laddr + ", lsigungucode=" + lsigungucode + ", ltel=" + ltel
				+ ", lcontenttypeid=" + lcontenttypeid + ", lcat1=" + lcat1 + ", lcat2=" + lcat2 + ", lcat3=" + lcat3
				+ ", lmapx=" + lmapx + ", lmapy=" + lmapy + ", lfirstimage=" + lfirstimage + "]";
